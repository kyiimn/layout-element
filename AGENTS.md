...
src/
  ...
  constants/                 # Constants: DEFAULT_FONT_SIZE, DEFAULT_PPM, z-index reservations, etc.
    ...
    index.ts
  utils/                     # checkOverlap, getOverlapSizePX, genUUID, ai-processing-overlay, objectFit, valueEqual, staticGridContains, clampStaticToContainer, clampAbsoluteToContainer

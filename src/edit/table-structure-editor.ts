...
export class TableStructureEditor {
  ...
  private _cloneCell(refTd: TableCellData): TableCellData {
    return {
      ...
      colspan: 1,
      rowspan: 1,
      borderTop: refTd.borderTop ? { ...refTd.borderTop } : undefined,
      borderRight: refTd.borderRight ? { ...refTd.borderRight } : undefined,
      borderBottom: refTd.borderBottom ? { ...refTd.borderBottom } : undefined,
      borderLeft: refTd.borderLeft ? { ...refTd.borderLeft } : undefined,
      ...
      while (logicalCol < colCount) {
        ...
        if (srcIdx < sourceRow.children.length) {
          ...
          children.push({
            ...
            rowspan: 1,
            borderTop: srcTd.borderTop ? { ...srcTd.borderTop } : undefined,
            borderRight: srcTd.borderRight ? { ...srcTd.borderRight } : undefined,
            borderBottom: srcTd.borderBottom ? { ...srcTd.borderBottom } : undefined,
            borderLeft: srcTd.borderLeft ? { ...srcTd.borderLeft } : undefined,

...
export class TableStructureEditor {
  ...
  private _cloneCell(refTd: TableCellData): TableCellData {
    return {
      ...
      colspan: 1,
      rowspan: 1,
      borderTopWidth: refTd.borderTopWidth,
      borderTopColor: refTd.borderTopColor,
      borderTopStyle: refTd.borderTopStyle,
      borderRightWidth: refTd.borderRightWidth,
      borderRightColor: refTd.borderRightColor,
      borderRightStyle: refTd.borderRightStyle,
      borderBottomWidth: refTd.borderBottomWidth,
      borderBottomColor: refTd.borderBottomColor,
      borderBottomStyle: refTd.borderBottomStyle,
      borderLeftWidth: refTd.borderLeftWidth,
      borderLeftColor: refTd.borderLeftColor,
      borderLeftStyle: refTd.borderLeftStyle,
      ...
      while (logicalCol < colCount) {
        ...
        if (srcIdx < sourceRow.children.length) {
          ...
          children.push({
            ...
            rowspan: 1,
            borderTopWidth: srcTd.borderTopWidth,
            borderTopColor: srcTd.borderTopColor,
            borderTopStyle: srcTd.borderTopStyle,
            borderRightWidth: srcTd.borderRightWidth,
            borderRightColor: srcTd.borderRightColor,
            borderRightStyle: srcTd.borderRightStyle,
            borderBottomWidth: srcTd.borderBottomWidth,
            borderBottomColor: srcTd.borderBottomColor,
            borderBottomStyle: srcTd.borderBottomStyle,
            borderLeftWidth: srcTd.borderLeftWidth,
            borderLeftColor: srcTd.borderLeftColor,
            borderLeftStyle: srcTd.borderLeftStyle,
